                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          SizedBox(height: 20,),
                          headingContainer("Payment information", 200,40),
                          SizedBox(height: 20,),
                          Container(
                            // height: 200,
                            decoration: BoxDecoration(
                                        ...
                                        Padding(
                                          ...
                                          child: RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text: 'Do you currently have a pension?',
                                                  style: TextStyle(
                                      ...
                                      Padding(
                                        ...
                                        child: RichText(
                                          text: TextSpan(
                                            children: [
                                              TextSpan(
                                                text: 'If yes please give details on your pension provider?',
                                                style: TextStyle(
                                                  color: Appcolor.lightBlack,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w700,
                                        ...
                                        Padding(
                                          ...
                                          child: RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text: 'Do you opt-in to continue your pension?',
                                                  style: TextStyle(
                                                    color: Appcolor.lightBlack,
                                                    fontSize: 14,
                                                    fontWeight: FontWeight.w700,
                            ...
                            if (globalKey.currentState!.validate()) {
                              sliderController.updateSliderValue(
                                  sliderController.currentSliderValue.value +
                                      1);
                              Get.toNamed('/ProfileScreenEmgContact');
                            }}),
                          ),
                        ],
                      ),
