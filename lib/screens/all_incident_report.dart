...
class AllIncidentReportScreen extends StatelessWidget {
  final ProfileViewController controller = Get.put(ProfileViewController());

  AllIncidentReportScreen({Key? key}) : super(key: key);
  final List<Map<String, String>> data = [
    {'S#': '1', 'Title': 'Arshik', 'Date': '5644645', 'Currency': 'GBP', 'Total': '265\$', 'Status': 'true', 'CreatedAt': '7/1/2024', 'Action': 'Ok'}
  ];

  final List<String> columns = ['S#', 'Title', 'Date', 'Currency', 'Total', 'Status', 'CreatedAt', 'Action'];
  @override
  Widget build(BuildContext context) {
    GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
    final mediaQuery = MediaQuery.of(context);
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: 20,),
                        lightBack( "All Incident-Reporting"),
                        SizedBox(height: 20,),
                        SizedBox(
                            width: 200,
                            child: gradientButton(onPressed: (){
                              Get.toNamed('addIncidentReportScreen');
